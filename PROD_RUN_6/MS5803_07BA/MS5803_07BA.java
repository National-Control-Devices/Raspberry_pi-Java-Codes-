...
public class MS5803_07BA
{
    ...
    public MS5803_07BA(int address)
    {
        try
        {
            // Get i2c bus
    ...
    void readSensor(int _Resolution) throws IOException{
        ...
        // For 1 bar sensor
        Offset = (long)sensorCoeffs[2] * 262144 + (sensorCoeffs[4] * (long)dT) / 32;
        Sensitivity = (long)sensorCoeffs[1] * 131072 + (sensorCoeffs[3] * (long)dT) / 128;
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        MS5803_07BA sensor =  new MS5803_07BA();
