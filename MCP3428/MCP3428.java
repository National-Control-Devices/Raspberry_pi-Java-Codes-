  ...
  public static void main(String[] args)
  {
    ...
    final NumberFormat NF = new DecimalFormat("##00.00");
      ...
      while(true)
      {
          ...
          sensor.selectChannel(CHANNEL_2,GAIN_1);
         
          System.out.println("OUTPUT FROM CHANNEL 3  : " + sensor.readADC());
          
          sensor.selectChannel(CHANNEL_3,GAIN_1);
          
          System.out.println("OUTPUT FROM CHANNEL 4  : " + sensor.readADC());
     }
