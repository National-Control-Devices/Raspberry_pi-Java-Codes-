...
public class MS5803_01BA
{
    ...
    public MS5803_01BA(int address)
    {
        try
        {
            // Get i2c bus
    ...
    void readSensor(int _Resolution) throws IOException{
        ...
        Sensitivity = (long)sensorCoeffs[1] * 32768 + (sensorCoeffs[3] * (long)dT) / 256;
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        MS5803_01BA sensor =  new MS5803_01BA();
