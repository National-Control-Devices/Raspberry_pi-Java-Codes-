...
{
    public final static int MCP3427_ADDRESS = 0x68;
    ...
    private I2CBus bus;
    private I2CDevice mcp3427;
    
    public MCP3427()
    {
        this(MCP3427_ADDRESS);
    }
    
    public MCP3427(int address)
    {
        try
        {
            // Get i2c bus
