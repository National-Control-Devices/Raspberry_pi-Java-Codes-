...
public class ADS1114
{
    ...
    private static int ADS1114_CONVERSIONDELAY = 8;
    private static int ADS1114_ADDRESS = 0x48;
    /*
     * =========================================================================
     * POINTER REGISTER
     * -----------------------------------------------------------------------
    ...
    private I2CBus bus;
    private I2CDevice ads1114;
    
    public ADS1114()
    {
        this(ADS1114_ADDRESS);
    }
    
    public ADS1114(int address)
    {
        try
        {
            // Get i2c bus
    ...
    int read16Bits(int address) throws IOException
    {
        ...
        ads1114.read(address, buffer, 0, buffer.length);
        int msb = buffer[0];
        int lsb = buffer[1];
        if (lsb < 0)
            lsb = 256 + lsb;
    ...
    void write16Bits(int address, int value) throws IOException
    {
        ...
        ads1114.write(address, buffer, 0, buffer.length);
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        ADS1114 sensor = new ADS1114();
        
        while(true)
        {
            System.out.println(" output :  " + sensor.read16Bits(0x00));
