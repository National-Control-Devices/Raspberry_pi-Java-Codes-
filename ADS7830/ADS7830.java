...
public class ADS7830
{
    ...
    public final static int ADS7830_ADDRESS = 0x48;
    ...
    private I2CBus bus;
    private I2CDevice ads7830;
 
    public ADS7830()
    {
        this(ADS7830_ADDRESS);
    }

  public ADS7830(int address)
  {
    try
    {
      // Get i2c bus
