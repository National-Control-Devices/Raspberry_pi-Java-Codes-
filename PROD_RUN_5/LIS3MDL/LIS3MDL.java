...
public class LIS3MDL
{
    ...
    public void setConfig(){
        ...
        try
        {
            ...
            lis3dml.write(0x22,(byte)0x00);   // Continuous-conversion mode
    ...
    public void getData(){
        ...
        try {
            ...
            */
            ...
            raw_x_g = raw_x_g & 0xffff;
            raw_y_g = raw_y_g & 0xffff;
            raw_z_g = raw_z_g & 0xffff;
       ...
       if(raw_x_g > 32768)
            raw_x_g = raw_x_g - 65536;
        
        if(raw_y_g > 32768)
            raw_y_g = raw_y_g - 65536;
        
        if(raw_z_g > 32768)
            raw_z_g = raw_z_g - 65536;
