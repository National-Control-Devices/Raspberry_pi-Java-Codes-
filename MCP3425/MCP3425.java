...
{
    public final static int MCP3425_ADDRESS = 0x68;
    ...
    private I2CBus bus;
    private I2CDevice mcp3425;
    
    public MCP3425()
    {
        this(MCP3425_ADDRESS);
    }
    
    public MCP3425(int address)
    {
        try
        {
            // Get i2c bus
    ...
    
    {
        ...
        //System.out.println("ADC output :  " + Long.toBinaryString(t));
    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
            ...
            System.out.println("OUTPUT  : " + sensor.readADC());
